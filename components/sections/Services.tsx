    ...
    <section id="services" className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
      <div className="mb-12 max-w-2xl">
        ...
        <h2 className="mt-3 text-4xl font-semibold tracking-tight md:text-5xl">
          Des services pensés pour les espaces exigeants.
        </h2>
      </div>

      <div className="grid gap-6 md:grid-cols-3">
        {services.map((service) => (
          <Card key={service.title} className="group overflow-hidden rounded-[1.75rem] border-0 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
